...
import {roughMaterial} from './physics';
const RED = 0xFF2E00;;
const BLUE = 0x23A8FC;
...
var makeBody = function(block) {
  ...
  switch (block) {
    ...
    case "t":
      var bottom = new CANNON.Box(new CANNON.Vec3 (
        BLOCK_WIDTH * 3,
        BLOCK_WIDTH,
        BLOCK_WIDTH
      ));
      var top = new CANNON.Box(new CANNON.Vec3 (
        BLOCK_WIDTH,
        BLOCK_WIDTH,
        BLOCK_WIDTH
      ));
    ...
    case "s":
      var topBottom = new CANNON.Box(new CANNON.Vec3(
        BLOCK_WIDTH * 2,
        BLOCK_WIDTH,
        BLOCK_WIDTH
      ));
